#ifndef GRAPHIC_METHODS_H
#define GRAPHIC_METHODS_H
...
bool Allegro_routines::_timed() {
	...
	if (evnt.type == ALLEGRO_EVENT_DISPLAY_CLOSE || evnt.keyboard.keycode == ALLEGRO_KEY_ESCAPE) runing = false;
	if (evnt.type == ALLEGRO_EVENT_TIMER) return true;
