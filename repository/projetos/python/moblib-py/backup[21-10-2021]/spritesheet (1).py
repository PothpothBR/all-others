...
# classe para importar spritesheets
# e com funcao para desenhar um quadro
class LoadSpriteSheet:
    
    # inicializacao <arquivo, numero de linhas, numero de colunas>
    def __init__(self, filename, cols, rows, surface, handle=0):
        ...
        h = self.cellheigth = self.rect.height / rows
