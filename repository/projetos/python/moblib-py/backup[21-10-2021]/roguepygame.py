...
arm = ss.spritesheet('rpgsprites//armas.png',8,8,tela,4)
efect = ss.spritesheet('rpgsprites//efects//12_nebula_spritesheet.png',8,8,tela,5)

anim_pers_w = anm.animation((0,0),3,37,2,5)
anim_pers_a = anm.animation((0,0),3,13,2,3)
anim_pers_s = anm.animation((0,0),3,1,2,3)
anim_pers_d = anm.animation((0,0),3,25,2,3)
